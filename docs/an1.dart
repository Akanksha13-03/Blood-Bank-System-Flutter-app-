...
class AnegativeBag1 extends StatefulWidget {
  const AnegativeBag1({super.key});

  @override
  State<AnegativeBag1> createState() => _AnegativeBag1State();
}

class _AnegativeBag1State extends State<AnegativeBag1> {
  @override
