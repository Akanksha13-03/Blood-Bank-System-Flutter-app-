...
class AnegativeBag3 extends StatefulWidget {
  const AnegativeBag3({super.key});

  @override
  State<AnegativeBag3> createState() => _AnegativeBag3State();
}

class _AnegativeBag3State extends State<AnegativeBag3> {
  @override
