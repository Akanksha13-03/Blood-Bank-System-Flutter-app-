...
class BnegativeBag4 extends StatefulWidget {
  const BnegativeBag4({super.key});

  @override
  State<BnegativeBag4> createState() => _BnegativeBag4State();
}

class _BnegativeBag4State extends State<BnegativeBag4> {
  @override
